...
class TD3PlusBCAug(AlgoBase):
    ...
    _impl: Optional[TD3PlusBCAugImpl]
    ...
    def __init__(
        ...
        *,
        ...
        impl: Optional[TD3PlusBCAugImpl] = None,
    ...
    def _update(self, batch: TransitionMiniBatch) -> Dict[str, float]:
        ...
        if self._grad_step % self._update_actor_interval == 0:
            actor_loss, extra_logs = self._impl.update_actor(batch)

            if len(extra_logs) == 2:
                main_actor_loss, bc_loss = extra_logs
                action_reg_loss = 0
            elif len(extra_logs) == 3:
                main_actor_loss, bc_loss, action_reg_loss = extra_logs
            else:
                raise ValueError
