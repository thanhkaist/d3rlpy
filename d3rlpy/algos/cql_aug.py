...
from .torch.cql_aug_impl import CQLAugImpl, DiscreteCQLAugImpl


class CQLAug(AlgoBase):
...
class DiscreteCQLAug(DoubleDQN):
    ...
    _alpha: float
    _impl: Optional[DiscreteCQLAugImpl]
    ...
    def __init__(
        ...
        *,
        ...
        scaler: ScalerArg = None,
        reward_scaler: RewardScalerArg = None,
        impl: Optional[DiscreteCQLAugImpl] = None,
        **kwargs: Any,
    ):
        super().__init__(
