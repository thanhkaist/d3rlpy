...
from .torch.ddpg_plus_bc_impl import DDPGPlusBCImpl


class DDPGPlusBC(AlgoBase):
    r"""Deep Deterministic Policy Gradients + BC algorithm.
    ...
    def __init__(
        ...
        *,
        ...
        impl: Optional[DDPGPlusBCImpl] = None,
        env_name: str = '',
        **kwargs: Any
    ):
        super().__init__(
