...
from .torch.td3_relational_impl import TD3PlusRelationImpl


class TD3PlusRelation(AlgoBase):
    r"""TD3+BC algorithm.
    ...
    _impl: Optional[TD3PlusRelationImpl]
    ...
    def __init__(
        ...
        *,
        ...
        use_gpu: UseGPUArg = True,
        scaler: ScalerArg = "standard",
        action_scaler: ActionScalerArg = None,
        reward_scaler: RewardScalerArg = None,
        impl: Optional[TD3PlusRelationImpl] = None,
        **kwargs: Any
    ):
        super().__init__(
    ...
    def _create_impl(
        ...
        self._impl = TD3PlusRelationImpl(
    ...
    def _update(self, batch: TransitionMiniBatch) -> Dict[str, float]:
        ...
        metrics.update(self._impl.log_metrics)
        return metrics
